...
function  FavoriteCards (props) {
    ...
    return (
        <div>
            <Col sm ={5}>
            <Card style={{ opacity: '.9','border-radius': '7px', marginLeft: '16%', marginTop: '10%',height: '35vh',width: '35vh',fontStyle: 'bold',borderColor: 'grey',boxShadow: 'inset 0 0 10px #000000',boxSizing: 'content box',borderStyle: 'ridge'}}>
                    <Card.Body>
